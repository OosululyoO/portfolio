    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="fixed inset-x-4 top-[8%] bottom-[4%] md:inset-x-24 md:top-[10%] md:bottom-[6%] bg-white rounded-[3rem] shadow-2xl z-[101] overflow-y-auto no-scrollbar">
            <div className="sticky top-0 right-0 p-8 flex justify-end z-[102] pointer-events-none">
              <button onClick={onClose} className="w-12 h-12 bg-white/80 backdrop-blur shadow-lg rounded-full flex items-center justify-center text-slate-900 hover:bg-black hover:text-white transition-all pointer-events-auto">
            ...
            <div className="max-w-5xl mx-auto px-8 md:px-16 pb-24 -mt-12">
              ...
              <article className="prose prose-slate prose-lg max-w-none prose-headings:font-black prose-headings:uppercase prose-p:text-slate-600 prose-img:rounded-[2rem] whitespace-pre-wrap">
